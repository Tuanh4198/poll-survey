package io.yody.yosurvey.web.rest;

import static io.yody.yosurvey.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static io.yody.yosurvey.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static io.yody.yosurvey.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import io.yody.yosurvey.IntegrationTest;
import io.yody.yosurvey.security.AuthoritiesConstants;
