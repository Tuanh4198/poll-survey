package io.yody.yosurvey.security.oauth2;
...
class CustomClaimConverterIT {
    ...
    void testConvert_withNamespacedRoles() {
        ...
        user.put("given_name", NAME);
        user.put("family_name", FAMILY_NAME);
//        user.putArray(NtsSecurityUtils.CLAIMS_NAMESPACE + "roles").add(AuthoritiesConstants.ADMIN).add(AuthoritiesConstants.USER);
        mockHttpGetUserInfo(user);
